...
export default function MemberPanel() {
  ...
  return (
      ...
      className="
        ...
        md:min-h-0 md:w-[340px] md:rounded-xl md:border md:border-zinc-200 md:shadow-xl
      "
    >
      {/* 會員頭像區 */}
      <div className="flex flex-col items-center px-6 pb-8 pt-10">
        <div className="relative">
          ...
          <button
            type="button"
            aria-label="更換會員頭像"
            className="absolute bottom-0 right-0 flex h-8 w-8 items-center justify-center rounded-full bg-white text-black shadow-md transition hover:scale-105 hover:bg-zinc-100"
          >
        ...
        {memberLists.map((item) => {
          ...
          return (
            <Link
              ...
              className={`
                flex h-[64px] items-center gap-4 border-b border-zinc-200 px-8 text-[18px] transition
                hover:bg-zinc-50
